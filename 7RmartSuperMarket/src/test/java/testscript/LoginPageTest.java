...
public class LoginPageTest extends Base {
	...
	HomePage home;
  @Test(description = "This class validates login functionality using different credential combinations", 
		  groups = "smoketest")
  ...
  public void verifyUserCanSignIn(String username,String password)  
  {
	  ...
	  Assert.assertTrue(dashboardIsDisplayed, constant.ERRORMSGFORLOGIN);//1st arg for true condition & 2nd for login error.
  }

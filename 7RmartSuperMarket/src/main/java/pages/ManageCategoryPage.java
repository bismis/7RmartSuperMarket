...
public class ManageCategoryPage {
	...
	@FindBy(xpath="//input[@placeholder='Enter the Category']")WebElement enterCateg;
	@FindBy(xpath="//li[contains(@class,'ms-elem-selectable')]")WebElement selectGroup_discount;
	@FindBy(id="main_img")WebElement chooseFile;
	@FindBy(xpath="//input[contains(@name,'top_menu') and @value='yes']")WebElement radioButton_yes_topMenu;
	@FindBy(xpath="//input[contains(@value,'yes') and contains(@name,'show_home')]")WebElement radioButton_yes_showHome;
	...
	{
	    /*JavascriptExecutor js = (JavascriptExecutor) driver;
	    js.executeScript("arguments[0].click();", radioButton_yes_showHome);
	    return this;*/
		
		save.click();         //the comment one is right way..but to check Screenshot utility ,used this to make the method fails.
		return this;
	}
